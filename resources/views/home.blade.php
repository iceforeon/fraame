...
<body class="flex flex-col h-full">
  <header>
    <div class="max-w-3xl mx-auto flex items-center justify-between py-4 border-b border-gray-200 px-4">
      <div>
  ...
  <footer class="shrink-0">
    <div class="relative max-w-3xl mx-auto flex items-center justify-between py-4 border-t border-gray-200 px-4 mt-5">
      <div>
        <a href="/" class="text-gray-900 font-bold hover:text-gray-700 hover:underline focus:underline">iceforeon</a>
      </div>
      <div class="flex items-center justify-between space-x-3">
        <a href="" target="_blank" class="text-gray-900 hover:text-gray-700">
