<div>
  <div class="flex item-center justify-between">
    ...
    <div>
      <a href="{{ route('watchlists.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
        New <span class="hidden sm:inline-block sm:ml-1">Watchlist</span>
      </a>
    </div>
  </div>
              ...
              <tr>
                ...
                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                  <div class="flex justify-end items-center space-x-3">
                    <a href="{{ route('watchlists.edit', $watchlist->hashid) }}" class="text-gray-400 hover:text-gray-600">
