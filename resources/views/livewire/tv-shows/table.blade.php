<div>
    <div class="flex item-center justify-between">
        ...
        <div>
            ...
            <a href="{{ route('tv-shows.create') }}" class="inline-flex items-center justify-center border border-transparent bg-gray-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 sm:w-auto">
                New TV Show
            </a>
        </div>
    </div>
