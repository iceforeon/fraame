<div>
    <div class="flex item-center justify-between">
        ...
        <div>
            ...
            <button wire:click="scrape" type="button" class="inline-flex items-center justify-center border border-transparent bg-white px-4 py-2 text-sm font-medium text-black hover:underline focus:outline-none sm:w-auto">
                <span wire:loading.remove wire:target="scrape">Scrape</span>
                <span wire:loading wire:target="scrape">Scraping...</span>
            </button>

            <a href="{{ route('items.create') }}" class="inline-flex items-center justify-center border border-transparent bg-gray-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 sm:w-auto">
                New item
            </a>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    <div class="flex justify-end items-center space-x-3">
                                        <a href="{{ route('items.edit', $item->hashid) }}" class="text-gray-400 hover:text-gray-600">
